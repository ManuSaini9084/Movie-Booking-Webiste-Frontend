      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">Movie Dekho</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to Movie Dekho,</p>
          <p>
            At Movie Dekho, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at Movie Dekho and immerse yourself in the captivating world
